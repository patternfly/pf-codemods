...
### dualListSelector-update-onAvailableOptionsSearchInputChanged [(#8793)](https://github.com/patternfly/patternfly-react/pull/8793)

We've updated the `onAvailableOptionsSearchInputChanged` prop for DualListSelector so that the `event` parameter is the first parameter. Handlers may require an update.
...
### dualListSelector-update-onChosenOptionsSearchInputChanged [(#8793)](https://github.com/patternfly/patternfly-react/pull/8793)

We've updated the `onChosenOptionsSearchInputChanged` prop for DualListSelector so that the `event` parameter is the first parameter. Handlers may require an update.
...
### dualListSelector-update-onListChange [(#8793)](https://github.com/patternfly/patternfly-react/pull/8793)

We've updated the `onListChange` prop for DualListSelector so that the `event` parameter is the first parameter. Handlers may require an update.
