...
ruleTester.run("formhelpertext-remove-props", rule, {
  valid: [
    ...
    {
      code: `import { FormHelperText } from '@patternfly/react-core/dist/esm/components/Form/index.js'; <FormHelperText />`,
    },
  ...
  invalid: [
    ...
    {
      code: `import { FormHelperText } from '@patternfly/react-core/dist/esm/components/Form/index.js'; <FormHelperText isError={true} isHidden={false} icon={<Icon />} component="div" />`,
      output: `import { FormHelperText } from '@patternfly/react-core/dist/esm/components/Form/index.js'; <FormHelperText     />`,
      errors: [
        {
          message: `isError prop for FormHelperText has been removed. Use HelperText and HelperTextItem directly in children.`,
          type: "JSXOpeningElement",
