  ...
  invalid: [
    {
      ...
      output: `import { Button, EmptyState, EmptyStateActions, EmptyStateBody, EmptyStateIcon, Title, EmptyStateHeader, EmptyStateFooter } from '@patternfly/react-core/dist/esm/components/EmptyState/index.js'; 
      <EmptyState>
        <EmptyStateHeader titleText="Empty state" icon={<EmptyStateIcon icon={CubesIcon} />} headingLevel="h5" />
        <EmptyStateBody>
          Some other content.
