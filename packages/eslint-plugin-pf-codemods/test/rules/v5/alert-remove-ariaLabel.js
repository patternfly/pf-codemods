...
ruleTester.run("alert-remove-ariaLabel", rule, {
  ...
  invalid: [
    ...
    {
      code: `import { Alert } from '@patternfly/react-core/dist/esm/components/Alert/index.js'; <Alert aria-label="tester" />`,
      output: `import { Alert } from '@patternfly/react-core/dist/esm/components/Alert/index.js'; <Alert  />`,
      errors: [
        {
          message: `aria-label prop for Alert has been removed and should not be used as it is not well supported on div elements without a role.`,
          type: "JSXOpeningElement",
    ...
    {
      code: `import { Alert as Al } from '@patternfly/react-core/dist/esm/components/Alert/index.js'; <Al aria-label="tester" />`,
      output: `import { Alert as Al } from '@patternfly/react-core/dist/esm/components/Alert/index.js'; <Al  />`,
      errors: [
        {
          message: `aria-label prop for Al has been removed and should not be used as it is not well supported on div elements without a role.`,
          type: "JSXOpeningElement",
